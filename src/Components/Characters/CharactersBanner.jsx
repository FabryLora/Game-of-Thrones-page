                ...
                {props.right ? (
                    <>
                        ...
                        <div style={{marginBottom: "3em"}}>
                            <h2 style={{marginBottom: 0, fontSize: "42px"}}>{`"${props.character.name}"`}</h2>
                            <p style={{marginTop: "0.3em"}}>&nbsp;&nbsp;-{props.character.alias}</p>
                        </div>
                        <p style={{wordWrap: 'break-word'}}>{props.character.desc}</p>
                        </motion.div>
                        <motion.div {...animationValues}>
                            <img src={props.character.image} style={{maxHeight: 500, maskImage: "linear-gradient(black 80%, transparent)"}}></img>
                        </motion.div>  
                    </>
                ) : (
                    <>
