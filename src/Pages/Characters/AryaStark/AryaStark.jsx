import { ariaStark } from "../../../Components/Characters/CharactersObject.jsx";
...
import aryaStarkInfo from "./AryaStarkInfo.jsx";
  ...
  return (
    <>
      ...
      <main className="flex justify-evenly bg-[url('./images/patron3.jpg')] bg-fixed pt-10 font-gothic max-md:flex-col max-md:items-center max-md:pt-28">
        <CharactersMainContent charac={aryaStarkInfo} />
        <CharacterDesc char={ariaStark} />
      </main>
    </>
  );
};
